...
% ephysDataset.cell_type contain cell type info
%
% Input
% sessionId  : ID of session to plot
%
% Plot
% blue: lick right
% red: lick left
...
% sessionIndex should be sessionId & cell_type needs to be 1 (regular spiking cell)
...
figure
hold on
plot(timeTag,nanmean(selectivity),'k')
gridxy([-2.6 -1.3 0],'Color','k','Linestyle','--') ;
xlim([-3  1.5]);
xlabel('Time (s)')
